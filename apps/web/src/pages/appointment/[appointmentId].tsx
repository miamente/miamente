...
const AppointmentPage: React.FC<AppointmentPageProps> = () => {
  ...
  useEffect(() => {
    const fetchAppointment = async () => {
      ...
      try {
        ...
        if (router.query.payment === 'success') {
          ...
          setTimeout(() => {
            router.replace(`/appointment/${appointmentId}`, undefined, { shallow: true });
          }, 5000);
        }
      } catch (err: any) {
    ...
    fetchAppointment();
  }, [appointmentId, router.query.payment]);
        ...
        {paymentSuccess && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
            <div className="flex items-center">
              ...
              <p className="text-green-700 font-medium">¡Pago realizado exitosamente!</p>
            </div>
            <p className="text-green-600 text-sm mt-1">
              Tu cita ha sido confirmada. Recibirás un email de confirmación pronto.
            </p>
          </div>
        )}
