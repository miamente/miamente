...
describe("AdminProfessionals", () => {
  ...
  it("should render the page title and description", async () => {
    ...
    (apiClient.getProfessionals as any).mockResolvedValue(mockProfessionals);
  ...
  it("should display error message when API fails", async () => {
    const { apiClient } = await import("@/lib/api");
    (apiClient.getProfessionals as any).mockRejectedValue(new Error("API Error"));
  ...
  it("should handle API errors gracefully during status toggle", async () => {
    const { apiClient } = await import("@/lib/api");
    (apiClient.getProfessionals as any).mockResolvedValue(mockProfessionals);
    (apiClient.toggleProfessionalStatus as any).mockRejectedValue(new Error("Toggle failed"));
  ...
  it("should handle API errors gracefully during professional deletion", async () => {
    const { apiClient } = await import("@/lib/api");
    (apiClient.getProfessionals as any).mockResolvedValue(mockProfessionals);
    (apiClient.deleteProfessional as any).mockRejectedValue(new Error("Delete failed"));
