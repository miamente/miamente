...
describe("SpecialtiesMultiSelect", () => {
  ...
  it("should render error state when error exists", () => {
    ...
    expect(
      screen.getByText("Error in Especialidades: Failed to load specialties"),
    ).toBeInTheDocument();
  });
  ...
  it("should render help tooltip when provided", () => {
    ...
    render(<SpecialtiesMultiSelect label="Especialidades" aria-describedby="help-text" />);
  ...
  it("should have proper accessibility attributes", () => {
    ...
    render(
      <SpecialtiesMultiSelect aria-label="Custom aria label" aria-describedby="description-id" />,
    );
