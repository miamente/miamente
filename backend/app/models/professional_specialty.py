...
class ProfessionalSpecialty(Base):
    ...
    specialty_id = Column(UUID(as_uuid=True), ForeignKey("specialties.id"), nullable=True)  # Reference to default specialty
    ...
    is_default = Column(Boolean, default=False, nullable=False)  # Boolean flag for default specialty
