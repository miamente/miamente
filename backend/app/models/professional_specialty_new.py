...
class ProfessionalSpecialty(Base):
    ...
    specialty_id = Column(
        UUID(as_uuid=True), ForeignKey("specialties_new.id"), nullable=False
    )
    ...
    professional = relationship(
        ...
        back_populates="professional_specialties_new",
    )
    specialty = relationship(
        "app.models.specialty_new.Specialty", foreign_keys=[specialty_id]
    )
