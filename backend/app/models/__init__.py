...
from app.models.professional_specialty import (
    ProfessionalSpecialty,
)  # Keep for backward compatibility
from app.models.modality import Modality  # New: intervention modalities
from app.models.therapeutic_approach import (
    TherapeuticApproach,
)  # New: therapeutic approaches
from app.models.specialty_new import (
    Specialty as SpecialtyNew,
)  # New: specialties without price/description
from app.models.professional_specialty_new import (
    ProfessionalSpecialty as ProfessionalSpecialtyNew,
)  # New: many-to-many specialties
