"""
Professional therapeutic approach service for managing professional therapeutic approaches.
"""
from typing import List, Optional
from sqlalchemy.orm import Session
from app.models.professional_therapeutic_approach import ProfessionalTherapeuticApproach
from app.schemas.professional_therapeutic_approach import ProfessionalTherapeuticApproachCreate, ProfessionalTherapeuticApproachUpdate
...
class ProfessionalTherapeuticApproachService:
    ...
    def get_professional_therapeutic_approaches(self, professional_id: str) -> List[ProfessionalTherapeuticApproach]:
        ...
        return self.db.query(ProfessionalTherapeuticApproach).filter(
    ...
    def add_therapeutic_approaches_to_professional(self, professional_id: str, approach_ids: List[str]) -> List[ProfessionalTherapeuticApproach]:
        ...
        for approach_id in approach_ids:
            approach = ProfessionalTherapeuticApproachCreate(
                ...
                therapeutic_approach_id=approach_id
            )
            db_approach = ProfessionalTherapeuticApproach(**approach.dict())
            self.db.add(db_approach)
