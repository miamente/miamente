...
class ProfessionalSpecialtyNewService:
    ...
    def update_professional_specialty(
        self, specialty_id: str, specialty_update: ProfessionalSpecialtyUpdate
    ) -> Optional[ProfessionalSpecialty]:
    ...
    def add_specialties_to_professional(
        self, professional_id: str, specialty_ids: List[str]
