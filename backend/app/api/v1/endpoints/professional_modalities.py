...
from app.schemas.professional_modality import ProfessionalModalityResponse, ProfessionalModalityCreate, ProfessionalModalityUpdate
...
@router.get("/professional/{professional_id}/default", response_model=ProfessionalModalityResponse)
...
def create_professional_modality(
    modality: ProfessionalModalityCreate,
    db: Session = Depends(get_db)
):
...
def delete_professional_modality(
    modality_id: str,
    db: Session = Depends(get_db)
):
