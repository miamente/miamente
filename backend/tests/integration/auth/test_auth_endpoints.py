...
class TestAuthEndpoints:
    ...
    def test_register_user_duplicate_email(self, client: TestClient):
        ...
        user_data = {"email": "test@example.com", "password": TEST_PASSWORDS["VALID"], "full_name": "Test User"}
    ...
    def test_register_user_invalid_email(self, client: TestClient):
        ...
        user_data = {"email": "invalid-email", "password": TEST_PASSWORDS["VALID"], "full_name": "Test User"}
    ...
    def test_login_user(self, client: TestClient):
        ...
        # Login
        login_data = {"email": "test@example.com", "password": TEST_PASSWORDS["VALID"]}
    ...
    def test_login_user_wrong_password(self, client: TestClient):
        ...
        login_data = {"email": "test@example.com", "password": TEST_PASSWORDS["INVALID"]}
    ...
    def test_login_professional(self, client: TestClient):
        ...
        # Login
        login_data = {"email": "professional@example.com", "password": TEST_PASSWORDS["VALID"]}
