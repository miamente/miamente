...
describe('Appointment Booking', () => {
    ...
    describe('bookAppointment', () => {
        ...
        it('should fail when slot is not available (already booked)', async () => {
            ...
            await expect(bookAppointmentCallable(mockRequest)).rejects.toThrow('Slot is no longer available');
        });
        ...
        it('should fail when user is not authenticated', async () => {
            ...
            const bookAppointmentCallable = test.wrap(bookAppointment);
            // Execute and expect failure
            await expect(bookAppointmentCallable(mockRequest)).rejects.toThrow('User must be authenticated');
        });
        it('should fail when required parameters are missing', async () => {
            ...
            const bookAppointmentCallable = test.wrap(bookAppointment);
            // Execute and expect failure
            await expect(bookAppointmentCallable(mockRequest)).rejects.toThrow('proId and slotId are required');
        });
    });
    describe('Slot Competition Scenarios', () => {
        it('should handle concurrent booking attempts for the same slot', async () => {
            ...
            await expect(bookAppointmentCallable(mockRequest2)).rejects.toThrow('Slot is no longer available');
        });
        it('should handle race condition where slot becomes unavailable during transaction', async () => {
            ...
            const bookAppointmentCallable = test.wrap(bookAppointment);
            // Execute and expect failure
            await expect(bookAppointmentCallable(mockRequest)).rejects.toThrow('Failed to book appointment');
        });
    });
    describe('Data Validation', () => {
        it('should validate professional rate is configured', async () => {
            ...
            const bookAppointmentCallable = test.wrap(bookAppointment);
            // Execute and expect failure
            await expect(bookAppointmentCallable(mockRequest)).rejects.toThrow('Professional rate not configured');
        });
        it('should validate slot belongs to specified professional', async () => {
            ...
            const bookAppointmentCallable = test.wrap(bookAppointment);
            // Execute and expect failure
            await expect(bookAppointmentCallable(mockRequest)).rejects.toThrow('Slot does not belong to the specified professional');
        });
    });
});
