...
describe('Admin Payment Functions', () => {
    ...
    describe('adminConfirmPayment', () => {
        ...
        it('should fail when user is not admin', async () => {
            ...
            await expect(adminConfirmPaymentCallable(mockRequest)).rejects.toThrow('Only admin users can confirm payments');
        });
        it('should fail when user is not authenticated', async () => {
            ...
            const adminConfirmPaymentCallable = test.wrap(adminConfirmPayment);
            // Execute and expect failure
            await expect(adminConfirmPaymentCallable(mockRequest)).rejects.toThrow('User must be authenticated');
        });
        it('should fail when appointment is not found', async () => {
            ...
            const adminConfirmPaymentCallable = test.wrap(adminConfirmPayment);
            // Execute and expect failure
            await expect(adminConfirmPaymentCallable(mockRequest)).rejects.toThrow('Appointment not found');
        });
        it('should fail when appointment status is not approvable', async () => {
            ...
            const adminConfirmPaymentCallable = test.wrap(adminConfirmPayment);
            // Execute and expect failure
            await expect(adminConfirmPaymentCallable(mockRequest)).rejects.toThrow("Appointment status 'confirmed' cannot be confirmed");
        });
        it('should fail when appointmentId is missing', async () => {
            ...
            const adminConfirmPaymentCallable = test.wrap(adminConfirmPayment);
            // Execute and expect failure
            await expect(adminConfirmPaymentCallable(mockRequest)).rejects.toThrow('appointmentId is required');
        });
    });
    describe('adminFailPayment', () => {
        ...
        it('should fail when user is not admin', async () => {
            ...
            const adminFailPaymentCallable = test.wrap(adminFailPayment);
            // Execute and expect failure
            await expect(adminFailPaymentCallable(mockRequest)).rejects.toThrow('Only admin users can fail payments');
        });
        it('should fail when appointment status is not failable', async () => {
            ...
            const adminFailPaymentCallable = test.wrap(adminFailPayment);
            // Execute and expect failure
            await expect(adminFailPaymentCallable(mockRequest)).rejects.toThrow("Appointment status 'confirmed' cannot be marked as failed");
        });
    });
