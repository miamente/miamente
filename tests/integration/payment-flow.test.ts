...
describe("Payment Flow Integration Tests", () => {
  ...
  describe("Auto-approve Payment Flow", () => {
    it("should complete payment flow with auto-approve enabled", async () => {
      ...
      const bookAppointment = httpsCallable(userContext.functions(), "bookAppointment");
      ...
      const mockApprovePayment = httpsCallable(userContext.functions(), "mockApprovePayment");
